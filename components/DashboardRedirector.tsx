...
const modules = [
  ...
  },
  {
    ...
    bgColor: 'bg-gradient-to-br from-rose-50/80 via-pink-50/60 to-red-50/40',
    borderColor: 'border-rose-200/50',
    glowColor: 'shadow-[0_0_50px_-12px_rgba(244,63,94,0.5)]',
    description:  'Maden üretim takibi ve makine performans analizi',
    features: ['Gerçek Zamanlı İzleme', 'OEE Analizi', 'Vardiya Yönetimi'],
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-lg text-white/70 mb-6 max-w-2xl">
                    Beş güçlü modül, sınırsız özelleştirme ve gerçek zamanlı AI destekli analitik ile iş süreçlerinizi dönüştürün. 
                  </p>
        ...
        <div className="mb-12 md: mb-16 animate-slide-in-blurred" style={{ animationDelay:  '0.2s' }}>
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full">
              ...
              <span className="text-sm text-white">5 Premium Modül</span>
            </div>
          </div>
                ...
                <div
                  ...
                  style={{
                    ...
                    background: `radial-gradient(circle, ${
                      ...
                      selectedModuleData?.color.includes('violet') ? '#8b5cf6' :
                      selectedModuleData?.color.includes('rose') ? '#f43f5e' :  '#f59e0b'
                    }, transparent)`,
                    animationDelay: `${i * 0.1}s`,
